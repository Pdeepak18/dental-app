...
const Productsection = () => {
  return (
    <section className="bg-[#666666] 	 p-10 ">
      ...
      <div>
        <h2 className="text-2xl text-slate-500 text-center	">
          OUR PRODUCT RANGE
        </h2>
      ...
      <div className="flex flex-wrap justify-center gap-4 mb-4 mt-12 items-stretch">
        ...
        <figure className="bgcard1 tg relative bg-image  cursor-pointer border-solid w-[100%] md:w-[25%] md:h-[45%] hover:scale-[1.05] ">
          <img
            src={serv1}
            alt=""
            className="bg image  md:w-full  h-[210px] md:h-[350px]"
          />
          <div className="middle">
            <Link to="/contactus">
              <div className="hidden md:block text">
          ...
          <figcaption className="absolute bottom-0 z-90 w-4/4 md:w-4/4 bg-black/50 px-5 py-2 text-white capt">
            ...
            <p className="mt-1 italic text-sm font-light hidden md:block">
              Fraglot Surgicals offers the best value Micro Surgery Instruments
        ...
        <figure className="bgcard1 tg relative  cursor-pointer border-solid w-[100%] md:w-[25%] md:h-[45%] hover:scale-[1.05] ">
          <img
            src={serv2}
            alt=""
            className="bg image   w-full h-[210px] md:h-[350px]"
          />
          <div className="middle">
            <Link to="/contactus">
              <div className="hidden md:block text">
          ...
          <figcaption className="absolute bottom-0 z-90 w-4/4 md:w-4/4 bg-black/50 px-5 py-2 text-white capt">
            ...
            <p className="mt-1 italic text-sm font-light hidden md:block">
              Fraglot Surgicals offers the best value Hair Transplant
              Instruments in surgical instruments.
            </p>
          </figcaption>
        </figure>
        ...
        <figure className="bgcard1 tg relative  cursor-pointer border-solid w-[100%] md:w-[25%] md:h-[45%] hover:scale-[1.05] ">
          ...
          <figcaption className="absolute bottom-0 z-90 w-4/4 md:w-4/4 bg-black/50 px-5 py-2 text-white capt">
            ...
            <p className="mt-1 italic text-sm font-light hidden md:block">
              Fraglot Surgicals offers the best value Nasal Rongeur for
              Rhinoscopy back biting 360 degree ENT instruments.
            </p>
          </figcaption>
        </figure>
        ...
        <figure className="bgcard1 tg relative  cursor-pointer border-solid w-[100%] md:w-[25%] md:h-[45%] hover:scale-[1.05] object-cover ">
          <img
            src={prod_2}
            alt=""
            className="bg image w-full  h-[210px] md:h-[350px]  object-cover bg-center"
          />
          <div className="middle">
            <Link to="/contactus">
              <div className="hidden md:block text">
          ...
          <figcaption className="absolute bottom-0 z-90 w-4/4 md:w-4/4 bg-black/50 px-5 py-2 text-white capt">
            ...
            <p className="mt-1 italic text-sm font-light hidden md:block">
              Fraglot Surgicals offers the best value Weil Blakesley nasal
              forceps Instruments in surgical instruments.
            </p>
          </figcaption>
        </figure>
        ...
        <figure className="bgcard1 tg relative  cursor-pointer border-solid w-[100%] md:w-[25%] md:h-[45%] hover:scale-[1.05] object-cover ">
          <img
            src={prod_3}
            alt=""
            className="bg image  w-full h-[210px] md:h-[350px] bg-center"
          />
          <div className="middle">
            <Link to="/contactus">
              <div className="hidden md:block text">
          ...
          <figcaption className="absolute bottom-0 z-90 w-4/4 md:w-4/4 bg-black/50 px-5 py-2 text-white capt">
            <h1 className="text-lg md:text-xl font-bold ">
              Osher Snyder IOL Cutting Instruments
            </h1>
            <p className="mt-1 italic text-sm font-light hidden md:block">
              Fraglot Surgicals offers the best value Osher Snyder IOL Cutting
              Instruments in surgical instruments.
            </p>
          </figcaption>
        </figure>
        ...
        <figure className="bgcard1 tg relative  cursor-pointer border-solid w-[100%] md:w-[25%] md:h-[45%] hover:scale-[1.05] object-cover">
          <img
            src={prod_9}
            alt=""
            className="bg image  w-full h-[210px] md:h-[350px] object-fit "
          />
          <div className="middle">
            <Link to="/contactus">
              <div className="hidden md:block text">
          ...
          <figcaption className="absolute bottom-0 z-90 w-4/4 md:w-4/4 bg-black/50 px-5 py-2 text-white capt">
            ...
            <p className="mt-1 italic text-sm font-light hidden md:block">
              Fraglot Surgicals offers the best value Laparoscopic New Multi
              Function Trocar in surgical instruments.
            </p>
          </figcaption>
        </figure>
      </div>
